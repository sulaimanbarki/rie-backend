<template>
    <form id="stacked-pill" @submit.prevent="update()" v-if="$cookies.get('permissions').includes('Write')">       
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
       ...
       loadSubCategories (){
        ...
        async loadCategories () {
            try {
                ...
                const editproduct = await axios.get(`${this.$base}product-edit-js/${this.id}`)
                this.category = [{"label": editproduct.data['category_name'], "value": editproduct.data['category_id']}]
                if (this.category)
                {
                    this.loadSubCategories()
                    this.subcategory = [{"label": editproduct.data['subcategory_name'], "value": editproduct.data['subcategory_id']}]
                }
                
                this.product_title = editproduct.data.product_name
                this.description = editproduct.data['product_details']
                this.model_number = editproduct.data.basic_model_number
                this.driving_method = editproduct.data.basic_driving_method
                this.total_length  = editproduct.data.size_total_length
                this.overall_width = editproduct.data.size_overall_width
                this.total_height = editproduct.data.size_total_height
                this.wheel_base = editproduct.data.size_wheel_base
                this.front_rear_suspension = editproduct.data.size_front_rear_suspension
                this.wheel_track = editproduct.data.size_wheel_track
                this.total_weight = editproduct.data.quality_total_weight
                this.total_vehicle_mass = editproduct.data.quality_total_vehicle_mass
                this.maximum_speed = editproduct.data.performance_maximum_speed
                this.minimum_turning_diameter = editproduct.data.performance_minimum_turning_diameter
                this.engine_model = editproduct.data.engine_engine_model
                this.engine_type = editproduct.data.engine_engine_type
                this.bore_diameter = editproduct.data.engine_bore_diameter
                this.compression_ratio = editproduct.data.engine_compression_ratio
                this.engine_stroke = editproduct.data.engine_engine_stroke,
                this.engine_displacement = editproduct.data.engine_engine_displacement,
                this.rated_speed = editproduct.data.engine_rated_speed
                this.rated_power = editproduct.data.engine_rated_power
                this.maximum_torque = editproduct.data.engine_maximum_torque
                this.engine_fuel_type = editproduct.data.engine_engine_fuel_type
                this.transmission_model = editproduct.data.transmission_transmission_model
                this.control_method = editproduct.data.transmission_control_method
                this.speed_ratio = editproduct.data.transmission_speed_ratio
                this.clutch_type = editproduct.data.clutch_clutch_type
                this.clutch_diameter = editproduct.data.clutch_clutch_diameter
                this.manipulation_method = editproduct.data.clutch_manipulation_method
                this.front_axle = editproduct.data.axle_front_axle
                this.rear_axle = editproduct.data.axle_rear_axle
                this.structure_type = editproduct.data.frame_structure_type
                this.standard_sizes = editproduct.data.frame_standard_sizes
                this.front_suspension_structure = editproduct.data.suspension_front_suspension_structure
                this.rear_suspension_structure = editproduct.data.suspension_rear_suspension_structure
                this.tyres_model = editproduct.data.tyres_tyres_model
                this.braking_type = editproduct.data.braking_braking_type
                this.driving_brake = editproduct.data.braking_driving_brake
                this.parking_brake = editproduct.data.braking_parking_brake
                this.auxiliary_brake = editproduct.data.braking_auxiliary_brake
                this.steering_type = editproduct.data.steering_steering_type
                this.capacity = editproduct.data.fuel_capacity
                this.material = editproduct.data.fuel_material
                this.cabin_type = editproduct.data.cabin_cabin_type
                this.vehicle_voltage = editproduct.data.electrical_vehicle_voltage
                this.battery = editproduct.data.electrical_battery
        ...
        async update () {
            ...
            try {
                const { data } = await axios.post(`${this.$base}product-update`, {
                    productid: this.id,
