    ...
    methods: {
        ...
        async update() {
            ...
            try { 
                ...
                const { data } = await axios.post(`${this.$base}update-page/${this.pageId}`, formData, config);
                loading.close()
        ...
        async loadApi () {
            try {
                const { data } = await axios.get(`${this.$base}pages-mgt/${this.pageId}`);
                this.page_title = data.page_title;
                this.page_buttonlabel = data.page_buttonlabel;
                this.page_url = data.page_url;
                this.page_details = data.page_details;
                this.page_summary = data.page_summary;

                this.menu_id = data.menu
            } catch (error) {
                alert(error)
            }
        }
