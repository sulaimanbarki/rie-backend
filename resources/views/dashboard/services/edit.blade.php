            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="services-mgt-update" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                <input type="hidden" name="serviceid" value="{{$service->service_id}}" id="">
                                <div class="col-lg-6">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        @endif
                                        <textarea class="form-control" name="service_summary" rows="4">{!! $service->service_excerpt !!}</textarea>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail" value={{ $service->service_cover }} class="form-control" type="text" name="service_cover">
                                      </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    <textarea id="my-editor" name="service_details" class="form-control">{!! $service->service_details !!}</textarea>
                                </div>
