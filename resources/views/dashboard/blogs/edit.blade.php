            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{!! route('blogs-mgt.update', $blog->blog_id) !!}" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                @method('PUT')
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        @endif
                                        <textarea class="form-control" name="blog_excerpt" rows="4">{!! $blog->blog_excerpt !!}</textarea>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail" value={{ $blog->blog_image }} class="form-control" type="text" name="blog_image">
                                      </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    <textarea id="my-editor" name="blog_details" class="form-control">{!! $blog->blog_details !!}</textarea>
                                </div>
