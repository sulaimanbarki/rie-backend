            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="slider-mgt" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                <div class="col-lg-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail" class="form-control" type="text" name="slider_cover" value="{{ old('slider_cover')}}">
                                      </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        @endif
                                        <textarea class="form-control" name="slider_summary" rows="4">{!! old('slider_summary') !!}</textarea>
                                    </fieldset>
                                </div>
