            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="job-update" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    @endif
                                    <textarea name="job_features" rows="5" class="form-control">{!! $job->job_features !!}</textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @endif
                                    <textarea name="job_benifits" rows="5" class="form-control">{!! $job->job_benefits !!}</textarea>
                                </div>
                                <div>&nbsp;</div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    <textarea id="my-editor" name="job_detail" class="form-control">{!! $job->job_detail !!}</textarea>
                                </div>
