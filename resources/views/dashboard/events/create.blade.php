            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="event-mgt" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                <div class="col-lg-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail" class="form-control" type="text" name="event_cover" value="{{ old('event_cover')}}">
                                      </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        @endif
                                        <textarea class="form-control" name="event_excerpt" rows="4">{{ old('event_excerpt')}}</textarea>
                                    </fieldset>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    <textarea id="my-editor" name="event_description" class="form-control">{!! old('event_description') !!}</textarea>
                                </div>
