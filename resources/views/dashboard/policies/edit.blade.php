            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{!! route('policies-mgt.update', $policy->policy_id) !!}" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                @method('PUT')
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    <textarea id="my-editor" name="content" class="form-control">{!! $policy->policy_body !!}</textarea>
                                </div>
                                <div>
                                    &nbsp;
                                </div>
