            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="add-product-images" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                ...
                                <div class="col-md-12">
                                    <textarea id="my-editor" style="display: none" name="service_details" class="form-control">{!! old('service_details') !!}</textarea>
                                </div>
                            ...
                            <table id="table-extended-success" class="table mb-0 dataTable no-footer" role="grid">
                                ...
                                <tr role="row" class="odd">
                                        ...
                                        <td><img style="width: 200px; height:200px" src="{{$item->product_image}}" alt="card"></td>
                                        <td>
                                            <div class="dropdown">
                                                <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="delete-product-image/{{$item->productimages_id}}" onclick="return confirm('Are you sure?')"><i class="bx bx-trash mr-1"></i> delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
