            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="contact-mgt" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        @endif
                                        <textarea class="form-control" name="contact_address" rows="4"></textarea>
                                    </fieldset>
                                </div>
