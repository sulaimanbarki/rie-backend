            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="sub-category-update" class="row" ref="form" v-if="$cookies.get('permissions').includes('Write')">
                                @csrf
                                <input type="hidden" name="subcategoryid" value="{{$subcategory->subcategory_id}}">
                                <div class="col-md-6">
                                    @php
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <select class="form-control" name="category">
                                            <option selected value="{{$subcategory->category_id}}">{{$subcategory->category_name}}</option>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail" class="form-control" type="text" name="subcategory_image" value="{{$subcategory->subcategory_image}}">
                                      </div>
